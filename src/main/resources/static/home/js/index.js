...
$(document).ready(function(){
    ...
    if($("body").children(".fade_back").size()==0){
        var feed_back = '<div class="fade_back"><h1><span class="fd_close">Close</span>Report to us</h1><div class="fade_area">'+
            '<div class="not_good"><h2>Please give us feedback! </h2><textarea id="feedback" placeholder="Please enter..."></textarea></div>'+
            '<div class="leave_name"><h2>Your contact</h2><textarea id="contact" placeholder="Email/Telephone"></textarea></div>' +
            '<a class="fd_btn" id="commit_fd" href="javascript:void(0);"></a></div></div><div class="thanks_fd">Thanks for you feedback!</div>';
    ...
    try{
        ...
        try{
            ...
            alert("Please use crtl+d to add!");
        }
    }
