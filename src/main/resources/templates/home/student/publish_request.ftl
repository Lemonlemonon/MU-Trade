                ...
                <div class="form-wr">
                    <div class="form-must-wr">
                        ...
                        <div class="form-item xl ads-desc">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <textarea name="content" id="desc" placeholder="Description, requirements, etc." class="required" tips="Please enter Ads detail "></textarea>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function(){
   $("#submit-btn").click(function(){
   		...
   		if(flag){
	   		...
	   		ajaxRequest('publish_request','post',$("#publish-form").serialize(),function(){
