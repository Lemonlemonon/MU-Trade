            ...
            <div class="main center">
                ...
                <div class="form-wr">
                    <div class="form-must-wr">
                    	...
                    	<input id="photo" type="hidden" name="photo" value="${goods.photo}" class="required" tips="Please upload images!">
                        ...
                        <div class="form-item l goods-title">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <input id="name" name="name" placeholder="32 charaters max" maxlength="32" value="${goods.name}" type="text" class="required" tips="Please enter Goods title"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-item xl goods-desc">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <textarea name="content" id="desc" placeholder="Description, condition, selling reason, etc." class="required" tips="Please enter Goods detail ">${goods.content}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-item l goods-price">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <input class="price required" id="buyPrice" name="buyPrice" value="${goods.buyPrice}" type="number" tips="Please enter original price"></div>
                            </div>
                        </div>
                        <div class="form-item l goods-price">
                            <div class="form-key">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <input class="price required" id="sellPrice" name="sellPrice" value="${goods.sellPrice}" type="number" tips="Please enter price now "></div>
                            </div>
                        </div>
