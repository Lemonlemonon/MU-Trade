                ...
                <div class="form-wr">
                    <div class="form-must-wr">
                        <div class="form-item l goods-title">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <input id="name" name="name" placeholder="32 charaters max" maxlength="32" value="${wantedGoods.name}" type="text" class="required" tips="Please enter Goods title"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-item xl goods-desc">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <textarea name="content" id="desc" placeholder="Description, condition, selling reason, etc." class="required" tips="Please enter Goods detail ">${wantedGoods.content}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-item l goods-title">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <input class="required" id="tradePlace" name="tradePlace" value="${wantedGoods.tradePlace}" type="text" tips="Please enter Trade location"></div>
                            </div>
                        </div>
                        <div class="form-item l goods-price">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <input class="price required" id="sellPrice" name="sellPrice" value="${wantedGoods.sellPrice}" type="number" tips="Please enter Expecting price"></div>
                            </div>
                        </div>
                    </div>
