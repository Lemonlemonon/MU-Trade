...
<title>${siteName!""}|Role management-Create role</title>
              ...
              <div class="card-body">
                <form action="add" id="role-add-form" method="post" class="row">
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="" placeholder="Please enter role name" tips="Please enter role name" />
                  </div>
	...
	$("#add-form-submit-btn").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				if(data.code == 0){
					showSuccessMsg('Role created!',function(){
