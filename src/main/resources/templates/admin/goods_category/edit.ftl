              ...
              <div class="card-body">
                <form action="add" id="category-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" readonly="readonly" class="form-control required" id="icon" name="icon" value="${goodsCategory.icon}" placeholder="Upload icon" tips="Upload icon" />
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="${goodsCategory.name}" placeholder="Enter category name" tips="Enter category name" />
                  </div>
                  <div class="input-group m-b-10">
