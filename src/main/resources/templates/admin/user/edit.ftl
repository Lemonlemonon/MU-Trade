              ...
              <div class="card-body">
                <form action="add" id="user-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="username" name="username" value="${user.username}" placeholder="Enter your username" tips="Enter your username" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">Password</span>
                    <input type="password" class="form-control required" id="password" name="password" value="${user.password}" placeholder="Enter a password" tips="Enter a password" />
                  </div>
                  <div class="input-group m-b-10">
	...
	$("#add-form-submit-btn").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				if(data.code == 0){
					showSuccessMsg('User edited!',function(){
