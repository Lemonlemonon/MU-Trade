...
<title>${siteName!""}|News management-Edit news</title>
              ...
              <div class="card-body">
                <form action="add" id="user-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="title" name="title" value="${news.title}" placeholder="Please enter the title" tips="Please enter the title" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">Content</span>
                    <textarea class="form-control required" id="content" name="content" rows="6" placeholder="Please enter news content" tips="Please enter news content">${news.content}</textarea>
                  </div>
                  <div class="input-group m-b-10">
	...
	$("#add-form-submit-btn").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				if(data.code == 0){
					showSuccessMsg('News edited',function(){
