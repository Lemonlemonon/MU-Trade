  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myLargeModalLabel">Icon select menu</h4>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" id="confirm-icon-btn" class="btn btn-primary">Confirm</button>
      </div>
    </div>
  </div>
</div>
...
$(document).ready(function(){
	//JavaScript uses the chart constant library for display
	showIcons();
});
