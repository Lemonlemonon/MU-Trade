              ...
              <div class="card-body">
                <form action="add" id="menu-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">Parent categary</span>
                    <select name="parent.id" class="form-control" id="type">
                        <option value="">Please select parent categary</option>
                        <#if topMenus??>
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="${menu.name}" placeholder="Please enter menu name" tips="Please enter menu name" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">Menu URL</span>
                    <input type="text" class="form-control" id="url" name="url" value="${menu.url}" placeholder="Please enter menu URL" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">Menu icon</span>
                    <input type="text" readonly="readonly" class="form-control required" id="icon" name="icon" value="${menu.icon}" placeholder="Please enter menu icon" tips="Select the menu icon" />
	...
	$("#add-form-submit-btn").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				if(data.code == 0){
					showSuccessMsg('Menu edit successfully!',function(){
