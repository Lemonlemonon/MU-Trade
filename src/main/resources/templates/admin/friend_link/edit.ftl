              ...
              <div class="card-body">
                <form action="add" id="user-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="${friendLink.name}" placeholder="Please enter the site name" tips="Please enter the site name" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">URL</span>
                    <input class="form-control required" id="url" name="url" value="${friendLink.url}" placeholder="Please enter the site URL" tips="Please enter the site URL">
                  </div>
                  <div class="input-group m-b-10">
