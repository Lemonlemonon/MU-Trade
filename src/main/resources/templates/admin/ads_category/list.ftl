                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <#list pageBean.content as adsCategory>
                      <tr>
                        <td style="vertical-align:middle;">
                          <label class="lyear-checkbox checkbox-primary">
                            <input type="checkbox" name="ids[]" value="${adsCategory.id}"><span></span>
                          </label>
                        </td>
                        <td style="vertical-align:middle;">
                        	<#if adsCategory.icon??>
                        		<#if adsCategory.icon?length gt 0>
                        		<img src="/photo/view?filename=${adsCategory.icon}" width="30px" height="30px">
                        		<#else>
                        		<img src="/admin/images/default-category-icon.png" width="30px" height="30px">
                        		</#if>
                        	</#if>
                        </td>
                        <td style="vertical-align:middle;">${adsCategory.name}</td>
                        <td style="vertical-align:middle;">
                        <#if adsCategory.parent??>
                        ${adsCategory.parent.name}
                        </#if>
                        </td>
                        <td style="vertical-align:middle;" align="center">${adsCategory.sort}</td>
                        <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${adsCategory.createTime}</font></td>
                      </tr>
                    </#list>
                    <#else>
