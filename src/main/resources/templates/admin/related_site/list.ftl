                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <#list pageBean.content as relatedSite>
                      <tr>
                        <td style="vertical-align:middle;">
                          <label class="lyear-checkbox checkbox-primary">
                            <input type="checkbox" name="ids[]" value="${relatedSite.id}"><span></span>
                          </label>
                        </td>
                        <td style="vertical-align:middle;">${relatedSite.name}</td>
                        <td style="vertical-align:middle;">
                        	${relatedSite.url}
                        </td>
                        <td style="vertical-align:middle;" align="center">${relatedSite.sort}</td>
                        <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${relatedSite.createTime}</font></td>
                      </tr>
                    </#list>
                    <#else>
