...
<title>${siteName!""}|Related site management-Edit site</title>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="add" id="user-add-form" method="post" class="row">
                  <input type="hidden" name="id" value="${relatedSite.id}">
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">Name</span>
                    <input type="text" class="form-control required" id="name" name="name" value="${relatedSite.name}" placeholder="Please enter the site name" tips="Please enter the site name" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">URL</span>
                    <input class="form-control required" id="url" name="url" value="${relatedSite.url}" placeholder="Please enter the site URL" tips="Please enter the site URL">
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">Sort</span>
                    <input type="number" class="form-control" id="sort" name="sort" value="${relatedSite.sort}" />
                  </div>
