...
<title>${siteName!""}|Request ads management-${title!""}</title>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="vertical-align:middle;">
                          <label class="lyear-checkbox checkbox-primary">
                            <input type="checkbox" name="ids[]" value="${requestAds.id}"><span></span>
                          </label>
                        </td>
                        <td style="vertical-align:middle;">
                        	${requestAds.name}
                        ...
                        <td style="vertical-align:middle;">
                        	${requestAds.student.sn}
                        </td>
                        <td style="vertical-align:middle;">
                        ${requestAds.sellPrice}
                        </td>
                        <td style="vertical-align:middle;">
                        ${requestAds.tradePlace}
                        </td>
                        
                        <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${requestAds.createTime}</font></td>
                      </tr>
                    </#list>
                    <#else>
