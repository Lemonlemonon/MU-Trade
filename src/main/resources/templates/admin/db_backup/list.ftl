                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <#list pageBean.content as dbBackup>
                      <tr>
                        <td style="vertical-align:middle;">
                          <label class="lyear-checkbox checkbox-primary">
                            <input type="checkbox" name="ids[]" value="${dbBackup.id}"><span></span>
                          </label>
                        </td>
                        <td style="vertical-align:middle;">${dbBackup.filename}</td>
                        <td align="center">${dbBackup.filepath}</td>
                        <td style="vertical-align:middle;"><font class="text-success">${dbBackup.createTime}</font></td>
                      </tr>
                    </#list>
                    <#else>
